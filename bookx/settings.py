...
ALLOWED_HOSTS = ["127.0.0.1", "localhost", "192.168.43.115"]
CSRF_TRUSTED_ORIGINS = ["http://192.168.43.115:8000"]  # only needed if you submit forms / use admin with DEBUG=False
